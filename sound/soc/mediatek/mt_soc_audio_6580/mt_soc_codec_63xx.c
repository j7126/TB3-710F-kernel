...
static void Voice_Amp_Change(bool enable)
{
    ...
    {
		printk("%s \n", __func__);
		mt_set_gpio_mode(GPIO11, GPIO_MODE_00); //speaker or receiver switch
...
#define SPK_WARM_UP_TIME        (25) //unit is ms
    ...
    if (enable)
    {
        ...
        AW8736_MODE3;
#else
		mt_set_gpio_out(GPIO11, GPIO_OUT_ZERO);//enable speaker
...
#ifndef CONFIG_MTK_SPEAKER
        mt_set_gpio_dir(GPIO11, GPIO_DIR_OUT);
        mt_set_gpio_out(GPIO11, GPIO_OUT_ONE); //disbale speaker
