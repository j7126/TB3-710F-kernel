...
static kal_uint32 charging_hw_init(void *data)
{
	...
	//bq24296_set_vindpm(0x0); //VIN DPM check 4.68V
	...
	bq24296_set_iinlim(0x4); //Termination input current 1A
	bq24296_set_ichg(0x7);  // Fast charge current 960ma
...
static kal_uint32 charging_enable(void *data)
{
	...
	else
	{
		...
		#endif
		{
			...
			if (charging_get_error_state() || (g_runin_battery_test_flag==1) ) {
